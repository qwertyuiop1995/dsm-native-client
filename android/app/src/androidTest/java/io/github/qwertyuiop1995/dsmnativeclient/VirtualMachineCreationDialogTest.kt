...
class VirtualMachineCreationDialogTest {
    ...
    fun 深色两倍字体下可滚动到创建复核() {
        ...
        rule.onNodeWithText(context.getString(R.string.virtual_machine_next_step)).performClick()
        rule.onNodeWithText(context.getString(R.string.virtual_machine_add_disk))
            .performScrollTo()
            .assertHeightIsAtLeast(48.dp)
            .performClick()
        rule.onNodeWithText(context.getString(R.string.virtual_machine_add_disk))
            .performScrollTo()
            .performClick()
        rule.onNodeWithText(context.getString(R.string.virtual_machine_remove_disk_number, 2))
            .performScrollTo()
            .assertHeightIsAtLeast(48.dp)
        rule.onNodeWithText(context.getString(R.string.virtual_machine_remove_disk_number, 3))
            .performScrollTo()
            .assertHeightIsAtLeast(48.dp)
        rule.onNodeWithText(context.getString(R.string.virtual_machine_next_step)).performClick()
        rule.onNodeWithText(context.getString(R.string.virtual_machine_add_network))
            .performScrollTo()
            .assertHeightIsAtLeast(48.dp)
            .performClick()
        rule.onNodeWithText(context.getString(R.string.virtual_machine_add_network))
            .performScrollTo()
            .performClick()
        rule.onNodeWithText(context.getString(R.string.virtual_machine_remove_network_number, 2))
            .performScrollTo()
            .assertHeightIsAtLeast(48.dp)
        rule.onNodeWithText(context.getString(R.string.virtual_machine_remove_network_number, 3))
            .performScrollTo()
            .assertHeightIsAtLeast(48.dp)
        rule.onNodeWithText(context.getString(R.string.virtual_machine_review))
            .performScrollTo()
