...
Android 14 真机完成既有冷启动，QuickConnect 已完成不含登录凭据的真实能力发现测试。本批照片写操作、
后台备份和 Chat 会话创建仍待设备与真实 NAS 复验；Chat 内部写能力只在运行时能力覆盖已记录版本时开放，其他能力继续按兼容证据分批接入。
